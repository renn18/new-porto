                ...
                >
                    ...
                    <div className="flex justify-center">
                        <button
                            ...
                            onClick={(e) => {
                                e.stopPropagation(); // Mencegah klik menyebar ke elemen <li>
...
export default function MyCarousel({ slides }: CarouselProps) {
    ...
    return (
        ...
        >
            ...
            <div className="absolute flex justify-center w-full bottom-[calc(100%+1rem)]">
                <CarouselControl
                    type="previous"
