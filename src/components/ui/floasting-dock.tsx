...
const FloatingDockMobile = ({
  ...
  return (
    <div className={cn("relative block md:hidden z-10", className)}>
      ...
      > 
        <IconLayoutNavbarCollapse className="h-5 w-5 text-neutral-900 dark:text-neutral-400" />
      </button>
    </div>
  );
};
...
const FloatingDockDesktop = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "mx-auto hidden md:flex h-16 gap-4 items-end  rounded-2xl bg-gray-300 dark:bg-neutral-900 px-4 pb-3",
        className
      )}
    >
      {items.map((item) => (
