    ...
    const data = [
            ...
            content: (
                <div>
                    <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
                        <Link href="https://eraport.darulasadiyah.rtechno.xyz/" target="_blank" className="hover:text-teal-500 text-sm md:text-lg">E-rapor Darul As&apos;adiyah (Laravel)</Link><br />
        ...
        },
        {
            ...
            content: (
                <div>
                    <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
                        <Link href="http://tokowiragrosir.rf.gd/" target="_blank" className="hover:text-teal-500 text-sm md:text-lg">Ship Data Services (Laravel)</Link><br />
                    ...
                    <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8 mt-12">
                        <Link href="http://tokowiragrosir.rf.gd/" target="_blank" className="hover:text-teal-500 text-sm md:text-lg">Toko Secilla Grosir (Native-PHP)</Link><br />
                    ...
                    <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8 mt-14">
                        <Link href="https://inventaris-ci3.infinityfreeapp.com/login" target="_blank" className="hover:text-teal-500 text-sm md:text-lg">Inventory System Management (CodeIgniter)</Link><br />
        ...
        },
        {
            ...
            content: (
                <div>
                    <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
                        <Link href="http://tokowiragrosir.rf.gd/" target="_blank" className="hover:text-teal-500 text-sm md:text-lg">E-repo (React)</Link><br />
                    ...
                    <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8 mt-14">
                        <Link href="https://renn-blog.vercel.app" target="_blank" className="hover:text-teal-500 text-sm md:text-lg">Portofolio (HTML)</Link><br />
        ...
        },
        {
            ...
            content: (
                <div>
                    <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
                        <Link href="https://renn-blog.vercel.app" target="_blank" className="hover:text-teal-500 text-sm md:text-lg">Renn Blog (React)</Link><br />
                    ...
                    <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8 mt-14">
                        <Link href="https://renn-games.netlify.app" target="_blank" className="hover:text-teal-500 text-sm md:text-lg">Renn Games (React Vite)</Link><br />
                    ...
                    <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8 mt-12">
                        <Link href="https://hi-renn.vercel.app" target="_blank" className="hover:text-teal-500 text-sm md:text-lg">Portofolio (React)</Link><br />
                        Old version of my portfolio website. Click the title for visit the app.
                    </p>
                    <div className="grid grid-cols-2 gap-4">
                        <Image
